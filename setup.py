...
setup(
    ...
    install_requires=[
        ...
        "argbind>=0.3.2",
        "numpy==1.23",
        "wavebeat @ git+https://github.com/tig3rmast3r/wavebeat",
        "lac @ git+https://github.com/tig3rmast3r/lac.git",
        "descript-audiotools @ git+https://github.com/tig3rmast3r/audiotools.git",
        "gradio", 
        "loralib",
        "torch_pitch_shift",
        "madmom",
